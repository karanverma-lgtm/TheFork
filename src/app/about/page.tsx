  ...
  return (
    <>
      ...
      <main className="flex-grow bg-white text-zinc-900 pt-32 pb-24 relative overflow-hidden">
        ...
        <div className="absolute top-[20%] right-[-10%] w-[45vw] h-[45vw] rounded-full bg-gold-200/10 blur-[120px] pointer-events-none select-none" />
        <div className="absolute bottom-[10%] left-[-10%] w-[50vw] h-[50vw] rounded-full bg-stone-200/20 blur-[120px] pointer-events-none select-none" />
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            ...
            <motion.div
              ...
              className="lg:col-span-5 relative rounded-2xl overflow-hidden border border-zinc-200/80 aspect-video lg:aspect-square"
            >
              <Image
          ...
          >
            <motion.div
              variants={itemVariants}
              className="lg:col-span-5 order-last lg:order-first relative rounded-2xl overflow-hidden border border-zinc-200/80 aspect-video lg:aspect-square"
            >
              <Image
            ...
            <motion.div variants={itemVariants} className="lg:col-span-7 flex flex-col gap-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 mt-4">
                <div className="flex gap-4">
                  <div className="w-10 h-10 rounded-lg bg-gold-50 border border-gold-500/20 flex items-center justify-center text-gold-600 shrink-0">
                    <HeartHandshake className="w-5 h-5" />
                  </div>
                  <div>
                    <h4 className="text-zinc-900 font-medium text-sm font-serif">Obsessed Servers</h4>
                    <p className="text-zinc-600 text-xs mt-1 font-light leading-relaxed">
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <h4 className="text-zinc-900 font-medium text-sm font-serif">Mouth-Watering Taste</h4>
                    <p className="text-zinc-600 text-xs mt-1 font-light leading-relaxed">
          ...
          <motion.div
            ...
            className="rounded-3xl border border-zinc-200/60 bg-[#fdfbf7] p-8 sm:p-16 relative overflow-hidden"
          >
            <div className="absolute top-0 right-0 w-80 h-80 bg-gold-200/10 blur-[100px] pointer-events-none" />
            <div className="max-w-3xl flex flex-col gap-6 relative z-10">
              <span className="text-xs tracking-[0.25em] font-semibold text-gold-600 uppercase">
                Our Vision
              </span>
              <h3 className="text-3xl sm:text-4xl font-serif font-medium text-zinc-900 tracking-tight leading-tight">
