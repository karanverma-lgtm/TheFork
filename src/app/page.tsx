...
export default function Home() {
  return (
    <>
      ...
      <main className="flex-grow bg-[#050505] text-[#f4f4f5] relative overflow-hidden">
        {/* Ambient background glows */}
        <div className="absolute top-[10%] left-[-10%] w-[50vw] h-[50vw] rounded-full bg-gold-950/20 blur-[120px] pointer-events-none select-none" />
        <div className="absolute top-[40%] right-[-10%] w-[45vw] h-[45vw] rounded-full bg-amber-950/15 blur-[120px] pointer-events-none select-none" />
        ...
        <section className="relative min-h-screen flex items-center justify-center pt-28 pb-20 px-6">
          <div className="absolute inset-0 z-0 select-none">
            ...
            <div className="relative w-full h-full opacity-35 filter brightness-[0.4] contrast-[1.1]">
              <Image
          ...
          <div className="max-w-5xl mx-auto text-center relative z-10 flex flex-col items-center gap-8">
            <motion.div
              ...
              className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-gold-500/25 bg-gold-950/10 text-gold-300 text-xs font-light tracking-[0.15em] uppercase"
            >
            ...
            <RevealText
              ...
              as="h1"
              className="text-4xl sm:text-6xl md:text-7xl font-serif font-semibold tracking-tight text-white leading-tight max-w-4xl"
            />
            ...
            <motion.p
              ...
              className="text-zinc-400 font-light text-sm sm:text-lg max-w-2xl leading-relaxed"
            >
            ...
            >
              ...
              <Link
                href="/services"
                className="flex items-center justify-center gap-1.5 text-zinc-300 hover:text-white font-medium text-sm tracking-wider uppercase px-8 py-4 border border-white/10 rounded-full hover:bg-white/5 transition-all duration-300 min-w-[200px]"
              >
                Our Services
        ...
        <section className="py-32 px-6 max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center relative z-10">
          <div className="flex flex-col gap-6 items-start">
            ...
            <div className="mt-4">
              <Link
                href="/about"
                className="group inline-flex items-center gap-2 text-gold-400 hover:text-gold-300 text-sm font-semibold tracking-wide uppercase transition-colors"
              >
          ...
          <div className="relative rounded-2xl overflow-hidden border border-white/10 aspect-video lg:aspect-square w-full">
            <Image
        ...
        <section className="py-24 bg-[#09090b] border-y border-white/5 relative z-10">
          <div className="max-w-7xl mx-auto px-6 grid grid-cols-2 md:grid-cols-4 gap-12 text-center">
            <div className="flex flex-col gap-2">
              <h3 className="text-4xl md:text-6xl font-serif font-semibold text-gold-400">
                <Counter value={10000} suffix="+" />
              </h3>
              <p className="text-zinc-500 text-xs md:text-sm uppercase tracking-widest font-light">Guests Served</p>
            </div>
            <div className="flex flex-col gap-2">
              <h3 className="text-4xl md:text-6xl font-serif font-semibold text-gold-400">
                <Counter value={4} suffix="" />
              </h3>
              <p className="text-zinc-500 text-xs md:text-sm uppercase tracking-widest font-light">Global Regions</p>
            </div>
            <div className="flex flex-col gap-2">
              <h3 className="text-4xl md:text-6xl font-serif font-semibold text-gold-400">
                <Counter value={5} suffix="★" />
              </h3>
              <p className="text-zinc-500 text-xs md:text-sm uppercase tracking-widest font-light">Food Quality Status</p>
            </div>
            <div className="flex flex-col gap-2">
              <h3 className="text-4xl md:text-6xl font-serif font-semibold text-gold-400">
                <Counter value={100} suffix="%" />
              </h3>
              <p className="text-zinc-500 text-xs md:text-sm uppercase tracking-widest font-light">Originality Assurance</p>
            </div>
          </div>
        </section>
        ...
        <section className="py-32 px-6 max-w-7xl mx-auto relative z-10">
          <div className="text-center flex flex-col items-center gap-4 mb-20">
            ...
            <h2 className="text-3xl sm:text-5xl font-serif font-medium tracking-tight text-white max-w-2xl leading-tight">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <SpotlightCard className="flex flex-col gap-6 justify-between h-full">
              <div className="flex flex-col gap-4">
                <div className="w-12 h-12 rounded-xl bg-gold-950/40 border border-gold-500/20 flex items-center justify-center text-gold-400">
                  <Flame className="w-6 h-6" />
                </div>
                <h3 className="text-xl font-serif font-medium text-white">Weddings & Receptions</h3>
              ...
              <Link href="/services#wedding" className="text-gold-400 hover:text-gold-300 text-xs font-semibold uppercase tracking-wider flex items-center gap-1 mt-4">
            ...
            <SpotlightCard className="flex flex-col gap-6 justify-between h-full">
              <div className="flex flex-col gap-4">
                ...
                <h3 className="text-xl font-serif font-medium text-white">Corporate Conventions</h3>
                <p className="text-zinc-400 text-sm font-light leading-relaxed">
                  Timely corporate lunches, conventions, and high-impact product launches customized to reinforce corporate prestige.
                </p>
              </div>
              <Link href="/services#corporate" className="text-gold-400 hover:text-gold-300 text-xs font-semibold uppercase tracking-wider flex items-center gap-1 mt-4">
                Learn More <ChevronRight className="w-3.5 h-3.5" />
              </Link>
            </SpotlightCard>
            ...
            <SpotlightCard className="flex flex-col gap-6 justify-between h-full">
              <div className="flex flex-col gap-4">
                ...
                <h3 className="text-xl font-serif font-medium text-white">Cocktails & Social Affairs</h3>
                <p className="text-zinc-400 text-sm font-light leading-relaxed">
                  Immersive bar configurations, global small-plates, and high-energy birthday bashes, designed to delight and engage.
                </p>
              </div>
              <Link href="/services#cocktail" className="text-gold-400 hover:text-gold-300 text-xs font-semibold uppercase tracking-wider flex items-center gap-1 mt-4">
                Learn More <ChevronRight className="w-3.5 h-3.5" />
              </Link>
            </SpotlightCard>
          </div>
        ...
        <section className="py-24 bg-[#08080a] border-t border-white/5 relative z-10">
          <div className="max-w-7xl mx-auto px-6">
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-16">
              <div className="flex flex-col gap-3">
                <span className="text-xs tracking-[0.3em] font-semibold text-gold-500 uppercase">Visual Showcase</span>
                <h2 className="text-3xl sm:text-5xl font-serif font-medium text-white tracking-tight">Our Curated Catering Portfolio</h2>
              </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {homeGallery.map((imgSrc, idx) => (
                <div
                  key={idx}
                  className="relative group rounded-xl overflow-hidden border border-white/5 aspect-[4/3] bg-zinc-900 cursor-pointer"
                >
                  <Image
                    src={imgSrc}
        ...
        <section className="py-32 relative z-10 text-center px-6">
          <div className="max-w-4xl mx-auto flex flex-col items-center gap-8">
            <h2 className="text-3xl sm:text-5xl md:text-6xl font-serif font-medium tracking-tight text-white leading-tight">
            ...
            <div className="mt-4">
              <MagneticButton>
                <Link
                  href="/contact"
                  className="inline-flex items-center gap-2 bg-white text-black font-semibold text-xs tracking-widest uppercase px-8 py-4.5 rounded-full hover:bg-gold-400 transition-all duration-300"
                >
                  Begin Designing
