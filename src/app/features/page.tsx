  ...
  return (
    <>
      ...
      <main className="flex-grow bg-white text-zinc-900 pt-32 pb-24 relative overflow-hidden">
        ...
        <div className="absolute top-[20%] right-[-10%] w-[55vw] h-[55vw] rounded-full bg-gold-200/10 blur-[130px] pointer-events-none select-none" />

        <div className="max-w-7xl mx-auto px-6">
          {/* Header */}
          <div className="max-w-3xl flex flex-col gap-6 mb-24">
            <span className="text-xs tracking-[0.3em] font-semibold text-gold-600 uppercase">Culinary Identity</span>
            <RevealText
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-32">
            {cuisines.map((cuisine, idx) => (
              <SpotlightCard key={idx} className="flex flex-col gap-6 h-full p-6">
                <div className="relative rounded-xl overflow-hidden border border-zinc-200/60 aspect-video w-full">
                  <Image
                    src={cuisine.image}
                    alt={cuisine.name}
                    fill
                ...
                <div className="flex flex-col gap-2">
                  <span className="text-xs tracking-wider text-gold-600 font-serif italic">{cuisine.tagline}</span>
                  <h3 className="text-2xl font-serif font-medium text-zinc-900">{cuisine.name}</h3>
                  <p className="text-zinc-600 text-sm font-light leading-relaxed mt-2">{cuisine.desc}</p>
                </div>
              </SpotlightCard>
            ))}
          </div>
          ...
          {/* Sourcing & Standards */}
          <div className="border-t border-zinc-200/60 pt-24 grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
            <div className="lg:col-span-6 flex flex-col gap-6">
              <span className="text-xs tracking-[0.3em] font-semibold text-gold-600 uppercase">Quality Assurance</span>
              <h2 className="text-3xl sm:text-4xl font-serif font-medium text-zinc-900 tracking-tight">
            ...
            <div className="lg:col-span-6 flex flex-col gap-8">
              <div className="flex gap-4">
                <div className="w-12 h-12 rounded-xl bg-gold-50 border border-gold-500/20 flex items-center justify-center text-gold-600 shrink-0">
                  <Leaf className="w-6 h-6" />
                </div>
                <div>
                  <h4 className="text-zinc-900 font-medium font-serif text-lg">Farm-Fresh Sourcing</h4>
                  <p className="text-zinc-600 text-sm font-light mt-1 leading-relaxed">
              ...
              <div className="flex gap-4">
                ...
                <div>
                  <h4 className="text-zinc-900 font-medium font-serif text-lg">Five-Star Culinary Standards</h4>
                  <p className="text-zinc-600 text-sm font-light mt-1 leading-relaxed">
              ...
              <div className="flex gap-4">
                ...
                <div>
                  <h4 className="text-zinc-900 font-medium font-serif text-lg">100% Originality Guarantee</h4>
                  <p className="text-zinc-600 text-sm font-light mt-1 leading-relaxed">
          ...
          {/* CTA Banner */}
          <div className="mt-32 rounded-3xl border border-zinc-200/60 bg-[#fdfbf7] p-8 sm:p-16 text-center relative overflow-hidden">
            <div className="max-w-2xl mx-auto flex flex-col items-center gap-6 relative z-10">
              <h3 className="text-2xl sm:text-4xl font-serif font-medium text-zinc-900 tracking-tight">Experience Our Cuisines Firsthand</h3>
